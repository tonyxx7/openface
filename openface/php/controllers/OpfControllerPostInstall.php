 ...
 */
/* controllers/OpfControllerPostInstall.php */
...
class OpfControllerPostInstall extends OpfController {
  ...
  public function execute() {
    OpfApplication::registerUser($this->context->getUserId(), 
      $this->context->getDbConnect(),
      $this->context->getDataSource());
    $this->renderApplication();
  } // execute

} // OpfControllerPostInstall
?>

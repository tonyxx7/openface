...
include_once($rDir.'php/portlets/PortletCardStore.php');
include_once($rDir.'php/views/CanvasBase.php');

class CanvasCardStore extends CanvasBase {

  const ICON = null;
  const TAG = 'cardStore';
  const LABEL_KEY = Localization::CARD_STORE;
  ...
  public function render() {
    $portlet = new PortletCardStore($this);
    $str = $portlet->render();
    return($str);
  } // render
